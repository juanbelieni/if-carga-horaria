  ...
  up() {
    this.raw(
      'create view cargas_horarias as select '
        ...
        + 'curso_id, '
        + 'disciplina_id '
        + 'from cargas as c inner join disciplinas as d on c.disciplina_id = d.id inner join cursos on cursos.id = c.curso_id inner join ppcs on ppcs.id = cursos.ppc_id',
    )
  }
